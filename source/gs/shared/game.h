...
#define GS_VM_CONTEXT_STACK_SIZE 15
	
// Game Paths
#define GS_PATH_LA_INDEX GS_PATH_DIR "COMI.LA0"
#define GS_PATH_LA_DISK_FMT GS_PATH_DIR "COMI.LA%ld"
#define GS_PATH_GS_DATA_DIR GS_PATH_DIR "data"
#define GS_PATH_GS_TABLE_DIR GS_PATH_GS_DATA_DIR "/tables"
#define GS_PATH_GS_ROOM_DIR GS_PATH_GS_DATA_DIR "/rooms"
#define GS_PATH_GS_SCRIPTS_DIR GS_PATH_GS_DATA_DIR "/scripts"
#define GS_PATH_GS_TABLE_FMT GS_PATH_GS_TABLE_DIR "/%s"
#define GS_PATH_GS_ROOM_FMT GS_PATH_GS_ROOM_DIR "/%ld"
#define GS_PATH_GS_GLOBAL_SCRIPT_FMT GS_PATH_GS_SCRIPTS_DIR "/%ld"
#define GS_PATH_GS_ROOM_SCRIPT_FMT GS_PATH_GS_SCRIPTS_DIR "/%ld.%ld"
