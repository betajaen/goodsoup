...
#define GS_GAME_FOURCC "COMI"
#define GS_GAME_VERSION 8
#define GS_SCREEN_WIDTH 640
#define GS_SCREEN_HEIGHT 480
#define GS_SCREEN_DEPTH 8
#define GS_BITMAP_LEFT 0
#define GS_BITMAP_TOP 0
#define GS_BITMAP_HALF_LEFT 160
#define GS_BITMAP_HALF_TOP 120
#define GS_BITMAP_PITCH 640
#define GS_BITMAP_ROWS 480
#define GS_BITMAP_HALF_PITCH 320
#define GS_BITMAP_HALF_ROWS 240
#define GS_BITMAP_SIZE (640 * 480)
#define GS_BITMAP_HALF_SIZE (320 * 240)
#define GS_INDEX_FILENAME "COMI."
